# Maze Navigation: GA vs Q-Learning vs A*

A bachelor's thesis project. A small grid agent (the "formula") navigates
procedurally generated mazes from a start cell to a goal cell. **Three methods**
...
many cells closer did the agent get?*). GA uses it in the shared fitness
...
src/
  ...
  environment/            agent, episode simulation
...
scripts/
  ...
  run_experiments.py      3-method comparison study
tests/                    pytest suite
```
...
Runs all three methods across several seeds (one freshly generated maze per seed,
...
`FitnessConfig`, `GAConfig`, `QLearningConfig`,
