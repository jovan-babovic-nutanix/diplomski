"""Shared fitness function used by both the GA and NEAT engines.
...
Design:
    ...
    * Output is clamped to a small positive floor so NEAT's fitness sharing
      (which allocates offspring proportionally) stays well-defined.
"""
